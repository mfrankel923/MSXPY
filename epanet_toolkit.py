# Code from: https://github.com/OpenWaterAnalytics/epanet-python/blob/dev/epanet-module/epamodule.py

#Function Documentation: http://wateranalytics.org/EPANET/index.html
...
if _plat=='Linux':
    _lib = ctypes.CDLL("/work/05881/mfrankel/stampede2/libepanet2.so")
elif _plat=='Windows':
  try:
...
def ENgetlinkid(index):
    ...
    if ierr!=0: raise ENtoolkitError(ierr)
    #the .decode() added my MF 6/10/21
    return label.value.decode()
